...
const copy = {
  en: {
    ...
    included: [
      ...
      "A rewritable NFC tag whose diameter and thickness you can measure",
      "An NFC-writing app on your phone",
      "A non-metal mounting position, or an NFC tag designed to work on metal",
    ],
    stepsTitle: "From model to first scan",
    steps: [
      ["Configure", "Open the generator with the NFC cavity enabled. Enter the measured tag diameter and thickness. For the simplest assembly, enable “open at bottom” so the NFC tag can be fitted after printing."],
      ...
      ["Choose a link", "Generate a six-digit personal link below. Use a different link for each chordlink that should have a different action on the same device."],
  ...
  de: {
    ...
    included: [
      ...
      "Einen wiederbeschreibbaren NFC-Tag, dessen Durchmesser und Dicke du messen kannst",
      "Eine App zum Beschreiben von NFC-Tags auf deinem Smartphone",
    ...
    steps: [
      ["Konfigurieren", "Öffne den Generator mit aktivierter NFC-Aussparung. Trage den gemessenen Durchmesser und die Dicke des Tags ein. Aktiviere für die einfachste Montage „open at bottom“, damit du den NFC-Tag nach dem Druck einsetzen kannst."],
      ["Drucken", "Exportiere eine STL-Datei oder die ausgerichteten Teile für den Zweifarbdruck. Eine geschlossene Tasche erfordert eine passend gesetzte Druckpause und einen Tag, der die Temperaturen verträgt; nutze die offene Aussparung, solange du diesen Ablauf nicht getestet hast."],
      ["Link auswählen", "Erzeuge unten einen persönlichen sechsstelligen Link. Verwende für jeden chordlink, der auf demselben Gerät eine andere Aktion ausführen soll, einen anderen Link."],
